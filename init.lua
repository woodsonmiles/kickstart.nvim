...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      --  Find LSPs here: https://github.com/neovim/nvim-lspconfig/blob/master/doc/server_configurations.md
      local servers = {
        pyright = {},
        jdtls = {},
        helm_ls = {},
      ...
      -- More packages at https://github.com/mason-org/mason-registry
